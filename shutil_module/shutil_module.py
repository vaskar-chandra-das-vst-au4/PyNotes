...
# path = r"C:\Users\Vaskar\Desktop\Code_Files\Python\mergePDF"

# pdfs = [pdf for pdf in os.listdir(path) if pdf.endswith(".pdf")]

# for x in range(len(pdfs)):
#     shutil.copy2(
#         rf"C:\Users\Vaskar\Desktop\Code_Files\Python\mergePDF\{pdfs[x]}",
#         r"C:\Users\Vaskar\Desktop\Code_Files\Python\shutil_module",
#     )

# shutil.move(r"C:\Users\Vaskar\Desktop\Code_Files\Python\test.txt", f"{os.getcwd()}")

# # Test code
# os.mkdir(r"C:\Users\Vaskar\Desktop\Code_Files\Python\TestFolder")
# for x in range(21):
#     os.mkdir(rf"C:\Users\Vaskar\Desktop\Code_Files\Python\TestFolder\Test {x}")

# shutil.rmtree(r"C:\Users\Vaskar\Desktop\Code_Files\Python\TestFolder")
